...
const PromotionPage = () => {
  ...
  const handleCreatePromotion = async () => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || "Не удалось создать тип продвижения";
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        ...
        <div>
          <Typography className="text-xl font-bold sm:text-3xl">Продвижение товаров</Typography>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Цена за день (₽)</label>
                <Input
                  min="0"
                  step="0.01"
                  type="number"
