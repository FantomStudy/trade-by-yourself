...
const CookiesPage = () => {
  return (
    <div className="mx-auto max-w-4xl bg-white px-4 py-10 text-gray-800">
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-xl font-bold">3. КАКИЕ ФАЙЛЫ COOKIES МЫ ИСПОЛЬЗУЕМ</h2>
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">5.1. Помимо cookies, мы можем использовать аналогичные технологии:</p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">6.2.1. Вы можете управлять cookies через настройки Вашего браузера:</p>
        ...
        <p className="mb-2 font-semibold">6.3. Отказ от аналитических и рекламных cookies</p>
        ...
        <p className="mb-1">6.4.2. Если Вы отключите только аналитические/рекламные cookies:</p>
        <ul className="mb-3 list-inside list-disc space-y-0.5 pl-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">7.2. По истечении срока хранения cookies автоматически удаляются.</p>
        <p className="mb-3">
          7.3. Вы можете удалить cookies вручную в любое время через настройки браузера.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-3">8.2. Актуальная версия Политики всегда доступна на данной странице.</p>
      </section>
    </div>
  );
};
