...
const ReadOnlyMapDynamic = dynamic(
  () => import("./read-only-map").then((mod) => ({ default: mod.ReadOnlyMap })),
  {
    ssr: false,
    loading: () => (
...
export const ProductMap = ({ address }: ProductMapProps) => {
  return <ReadOnlyMapDynamic address={address} />;
};
